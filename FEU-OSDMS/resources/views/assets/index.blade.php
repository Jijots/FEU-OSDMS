            ...
            <div class="flex flex-col lg:flex-row lg:items-center justify-between mb-14 px-4 sm:px-0 gap-8">
                ...
                <div class="shrink-0">
                    <a href="{{ route('assets.create') }}" class="btn-primary">
                        <svg class="w-5 h-5 group-hover:rotate-90 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="4"><path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4"></path></svg>
                        REPORT NEW ASSET
                    </a>
                </div>
            </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-slate-50">
                                ...
                                <tr class="group hover:bg-slate-50/30 transition-all duration-500">
                                    ...
                                    <td class="px-6 py-12 text-center">
                                        @php
                                            ...
                                            if ($status === 'Claimed') $style = 'background: #f0fdf4; color: #166534; border: 1.5px solid #dcfce7;';
                                            elseif ($status === 'Pending Review') $style = 'background: #fffaf0; color: #9a3412; border: 1.5px solid #ffedd5;';
                                            elseif ($status === 'Matched - Pending Surrender') $style = 'background: #f0f9ff; color: #075985; border: 1.5px solid #e0f2fe;';
                                            elseif ($status === 'Lost') $style = 'background: #fef2f2; color: #b91c1c; border: 1.5px solid #fee2e2;';
                                        @endphp
                            ...
                            @empty
                                <tr><td colspan="5" class="px-8 py-40 text-center text-slate-200 font-black uppercase tracking-[0.4em] text-sm">Terminal Idle — No Records</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
