        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border-l-4 border-blue-600">
                    ...
                    <p class="text-2xl font-black text-gray-900">5 Found</p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div class="bg-white p-6 rounded-xl shadow-sm">
                    ...
                    <form action="{{ route('students.index') }}" method="GET">
                        <input type="text" name="search" placeholder="Type ID or Name..." 
                               class="w-full border-gray-200 rounded-lg focus:ring-green-600 focus:border-green-600">
                        <button class="mt-3 w-full bg-green-700 text-white font-bold py-2 rounded-lg hover:bg-green-800 transition">
                            Open Profile
                        </button>
                    </form>
                </div>
                ...
                <div class="bg-gray-900 p-6 rounded-xl shadow-sm text-white">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <a href="{{ route('gate.index') }}" class="bg-white/10 p-4 rounded-lg hover:bg-white/20 transition text-center">
                            <span class="block text-lg">🚪</span>
                            <span class="text-xs font-bold">Gate Log</span>
                        </a>
                        <a href="{{ route('violations.report') }}" class="bg-white/10 p-4 rounded-lg hover:bg-white/20 transition text-center">
                            <span class="block text-lg">📊</span>
